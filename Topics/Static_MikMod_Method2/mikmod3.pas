...
begin
  WriteLn('unit mikmod3 is being initialized (no actual code, just this message)');
end;
...
begin
  WriteLn('unit mikmod3 is being finalized (no actual code, just this message)');
end;
